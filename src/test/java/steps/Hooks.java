...
public class Hooks {
    ...
    public void user_navigates_to_web_orders_application(String webApp) {
        ...
        } else if (webApp.equals("HRMApp")) {
            driver.get(ConfigReader.getProperty("HRMAppURL"));
        } else if (webApp.equals("BuySellAndRead")) {
            driver.get(ConfigReader.getProperty("BuySellAndReadURL"));
        }
    }
